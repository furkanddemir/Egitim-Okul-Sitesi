...
<html>
  ...
  <body>
    ...
    <div class="menu">
      ...
      <h1>ELEKTRİK ELEKTRONİK</h1>
	  
    <section id="elektrik-elektronik">
	</section>
	
	<h3>Elektrik Elektronik Bölümü Nedir?</h3><br>
	<p class="metinler">Elektronik mühendisliği, elektronik devreler, cihazlar, VLSI cihazları ve sistemlerini tasarlamak için doğrusal
	olmayan ve aktif elektrik bileşenlerini (yarı iletken cihazlar, özellikle transistörler, diyotlar ve entegre devreler gibi) kullanan
	bir elektrik mühendisliği disiplinidir.<br><br><br>

	Disiplin ayrıca genellikle baskılı devre kartlarına dayanan pasif elektrikli bileşenler tasarlar.
	Elektronik, daha geniş elektrik mühendisliği akademik konusu içinde bir alt alandır ancak analog elektronik, dijital elektronik,
	tüketici elektroniği, gömülü sistemler ve güç elektroniği gibi alt alanları kapsayan geniş bir mühendislik alanını ifade eder.</p>
	<br><br><br>
	
	
	<h3>Elektrik Elektronik Bölümü Ders Programı</h3><br>
		...
		$query = "SELECT * FROM Dersler WHERE bolum_id = 201";
		...
		<h3>Elektrik Elektronik Bölümü Öğretmenlerimiz</h3><br>
		...
		$query = "SELECT * FROM ogretimelemanlari WHERE bolum_id = 201";
		$result = mysqli_query($baglanti, $query);
	...
	<h3>Elektrik Elektronik Bölümü Bölüm Başkanı</h3><br>
		...
		$query = "SELECT * FROM Bolumler WHERE bolum_id = 201";
		$result = mysqli_query($baglanti, $query);
	...
	<h3>Elektrik Elektronik Bölümü Bölüm Ücreti</h3><br>
		...
		$query = "SELECT bolum_tutari FROM bolumler WHERE bolum_id = 201";
		$result = mysqli_query($baglanti, $query);
